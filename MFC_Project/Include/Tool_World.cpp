...
void CTool_World::OnBnClickedMw1222BtnSpawnMonster()
{
	...
	if (pMonster->Get_Name() == L"Hod_Tower")
	{
		pMonster->Set_BodyBoneName("bone_TemporaryTower_Body");
	}
	if (pMonster->Get_Name() == L"Hod_Cannon")
	{
		pMonster->Set_BodyBoneName("body_Rot_01_Tan");
	}

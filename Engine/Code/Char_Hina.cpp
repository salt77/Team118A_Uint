...
void CChar_Hina::Set_GuideSkill()
{
	CSkillGuideObject* pGuide = nullptr;
	pGuide = CSkill_Manager::GetInstance()->SetSkillGuideFan(Get_Position(), Get_Angle(), 9.f, 25.f, 9999.f, 10, FALSE, L"../../Reference/Resource/Texture/Test/GuideTexBlue.png");
	if (pGuide)
	{
...
void CChar_Hina::GuideSkillSetting(_vec3 vPickPos)
{

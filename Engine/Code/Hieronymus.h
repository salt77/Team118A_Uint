...
private:
	...
	{
		Rand_Bomb, Straight_Circles, _3, Bezier_Targetting, Line3, CutView,
		RandWarn_END
	};
...
private:
	...
	void						Hieronymus_Impact_2_Shake();
...
protected:
	...
	// 컷뷰액션
	_float						m_fCutViewTotalTime			= 3.5f;
	_float						m_fCutViewCoolTime			= 10.f;
	_float						m_fCutViewOnce				= 10.f;
	_int						m_iCutViewTime				= 16;

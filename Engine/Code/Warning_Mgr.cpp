...
void CWarning_Mgr::Create_Line_TwoWay(CWarning * pOrigin, _float fAngle, _float fDistance, _int iCount, _float fBaseDelay, _float fDelay, _vec3 vCenterPos, _vec4 vBegin, _vec4 vEnd)
{
	for (_int i = 0; i < iCount - 1; ++i)
	{
		...
		CScene::Get_MainScene()->Add_GameObjectNextFrame_ForLoading(E_LAYERTAG::Effect, E_OBJTAG::OBJ_Effect, pWarn_Minus);
		...
		CScene::Get_MainScene()->Add_GameObjectNextFrame_ForLoading(E_LAYERTAG::Effect, E_OBJTAG::OBJ_Effect, pWarn_Plus);
	}
}

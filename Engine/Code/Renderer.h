...
public:
	...
	void					Update_RenderDebug(const _float& fTimeDelta);

	void					Set_ViewCut_Fix(_float fTime, T_ViewCut tViewcutFix);
	T_ViewCut&				Get_ViewCut_Fix();
...
private:
	...
	_float					m_fRenderDebug_Time				= 1.f;
	_bool					m_bRenderDebug_Table			= FALSE;

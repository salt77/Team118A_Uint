...
public:
	CSphereCollider*		Get_Col_Head() { return m_pHead; }
...
public:
	void					Hit_Shield(const _float& fTimeDelta);
...
private:
	...
	CHod_Tower*				m_pHod_Tower = nullptr;
...
private:
	...
	CSphereCollider*		m_pTower_Lid_L		= nullptr;
	const char*				m_szTower_Lid_L		= "bone_Head_Lid_L_01";
...
private:
	_bool					m_bEXS5Distance = false;
	_float					m_fEXS5Distance = 0.f;
	_float					m_fEXS5ColTime = 0.f;
...
private:
	_bool					m_bOneceHit1 = true;
	_bool					m_bOneceHit2 = true;
	_bool					m_bOneceHit3 = true;

private:
	_bool					m_bHit_Damage = false;
};
